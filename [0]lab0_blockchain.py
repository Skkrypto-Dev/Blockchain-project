import hashlib #import hashlib library
...
class Blockchain: #block chain class
    ...
    def valid_chain(self, chain):
        # 각 블록을 순회하고 해시와 작업증명이 확인하여 유효한지를 검사
        ...
        while current_index < len(chain):
            ...
            if block['previous_hash'] != last_block_hash: #if the value calculated is different from hash block before, the problem will occur in networks.
                return False
    ...
    def new_block(self, proof, previous_hash):
        ...
        block = {
            ...
            'transactions': self.current_transactions, # transaction
            'proof': proof, # If it passed POW function, proof has 1 or more
            'previous_hash': previous_hash or self.hash(self.chain[-1]),# previous value.
        }
